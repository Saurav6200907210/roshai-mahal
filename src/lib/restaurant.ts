...
export const MENU: MenuItem[] = [
  ...
  { name: "Paneer Do Pyaza", price: "130/260", category: "Paneer Items", veg: true, image: IMG.paneerDoPyaza, desc: "Paneer cooked with double onions and spices." },
  ...
  { name: "Paneer Handi", price: "160/320", category: "Paneer Items", veg: true, image: IMG.paneerHandi, desc: "Slow-cooked paneer in clay handi." },
  ...
  { name: "Matar Paneer", price: "120/230", category: "Paneer Items", veg: true, image: IMG.matarPaneer, desc: "Paneer and green peas in spiced gravy." },
  { name: "Paneer Kassa", price: "130/250", category: "Paneer Items", veg: true, image: IMG.paneerKassa, desc: "Bengali-style spicy paneer kassa." },
  { name: "Paneer Kofta", price: "110/220", category: "Paneer Items", veg: true, image: IMG.paneerKofta, desc: "Soft paneer dumplings in creamy gravy." },
  ...
  { name: "Paneer Chatpata", price: "240", category: "Paneer Items", veg: true, image: IMG.paneerChatpata, desc: "Tangy chatpata paneer." },
  { name: "Paneer Maharashtrian", price: "120/220", category: "Paneer Items", veg: true, image: IMG.paneerMaharashtra, desc: "Maharashtrian spiced paneer curry." },
  ...
  { name: "Chicken Special Rice", price: "220", category: "Hot Rice", veg: false, image: IMG.chickenSpecialRice, desc: "Chef's special chicken rice." },
  { name: "Mix Fried Rice", price: "250", category: "Hot Rice", veg: false, image: IMG.mixFriedRice, desc: "Mixed meat and veg fried rice." },
  ...
  { name: "Missi Roti", price: "40", category: "Roti / Naan", veg: true, image: IMG.missiRoti, desc: "Spiced gram-flour roti." },
  { name: "Lachha Paratha", price: "40", category: "Roti / Naan", veg: true, image: IMG.lachhaParatha, desc: "Flaky multilayered paratha." },
  { name: "Kulcha (Plain/Masala)", price: "40/50", category: "Roti / Naan", veg: true, image: IMG.kulcha, desc: "Soft Amritsari-style kulcha." },
  { name: "Mughlai Paratha (Veg/Non-Veg)", price: "40/60", category: "Roti / Naan", veg: true, image: IMG.mughlaiParatha, desc: "Stuffed and fried Mughlai paratha." },
  { name: "Stuff Naan", price: "70", category: "Roti / Naan", veg: true, image: IMG.stuffNaan, desc: "Naan stuffed with chef's filling." },
  ...
  { name: "Special Naan", price: "90", category: "Roti / Naan", veg: true, image: IMG.specialNaan, desc: "Chef's premium stuffed naan." },
  { name: "Tawa Roti (Plain/Butter)", price: "10", category: "Roti / Naan", veg: true, image: IMG.tawaRoti, desc: "Skillet-cooked whole-wheat roti." },
  ...
  { name: "Paneer Pulao", price: "180", category: "Pulao / Biryani", veg: true, image: IMG.paneerPulao, desc: "Pulao tossed with paneer cubes." },
  { name: "Veg Kashmiri Pulao", price: "190", category: "Pulao / Biryani", veg: true, image: IMG.kashmiriPulao, desc: "Sweet & nutty Kashmiri pulao." },
  { name: "Veg Navratan Pulao", price: "220", category: "Pulao / Biryani", veg: true, image: IMG.navratanPulao, desc: "Nine-treasure royal pulao." },
  { name: "Shahi Pulao", price: "190", category: "Pulao / Biryani", veg: true, image: IMG.shahiPulao, desc: "Royal Mughlai shahi pulao." },
  ...
  { name: "Dum Biryani (Veg/Chicken)", price: "180/220", category: "Pulao / Biryani", veg: false, popular: true, image: IMG.dumBiryani, desc: "Slow-dum cooked royal biryani." },
  ...
  { name: "Dal Masani", price: "140", category: "Dal", veg: true, image: IMG.dalMakhani, desc: "Rich, spiced masani dal." },
  { name: "Dal Mughlai", price: "160", category: "Dal", veg: true, image: IMG.dalMughlai, desc: "Creamy Mughlai-style dal." },
  { name: "Dal Punjabi Butterwali", price: "180", category: "Dal", veg: true, image: IMG.dalPunjabi, desc: "Slow-cooked Punjabi butter dal." },
  ...
  { name: "Chicken Do Pyaza (2 pcs)", price: "160", category: "Chicken Items", veg: false, image: IMG.chickenDoPyaza, desc: "Chicken with double onions." },
  { name: "Chicken Curry (2 pcs)", price: "140", category: "Chicken Items", veg: false, image: IMG.chickenCurry, desc: "Home-style chicken curry." },
  ...
  { name: "Chicken Kassa (4/8 pcs)", price: "300/580", category: "Chicken Items", veg: false, image: IMG.chickenKassa, desc: "Bengali-style chicken kassa." },
  { name: "Chicken Korma (4 pcs)", price: "400", category: "Chicken Items", veg: false, image: IMG.chickenKorma, desc: "Royal korma in cashew gravy." },
  ...
  { name: "Chicken Bhuna", price: "360", category: "Chicken Items", veg: false, image: IMG.chickenBhuna, desc: "Slow-bhuna chicken with deep flavors." },
  { name: "Chicken Roaster (Dry/Gravy)", price: "230/250", category: "Chicken Items", veg: false, image: IMG.chickenRoaster, desc: "Char-roasted chicken." },
  ...
  { name: "Chicken Nawabi", price: "450/650", category: "Chicken Items", veg: false, image: IMG.chickenNawabi, desc: "Nawabi rich chicken curry." },
  { name: "Chicken Noorani (4 pcs)", price: "300", category: "Chicken Items", veg: false, image: IMG.chickenNoorani, desc: "Mild creamy noorani chicken." },
  { name: "Chicken Kashmiri (2 pcs)", price: "220", category: "Chicken Items", veg: false, image: IMG.chickenKashmiri, desc: "Kashmiri-spiced chicken." },
  ...
  { name: "Chicken Handi", price: "350/680", category: "Chicken Items", veg: false, image: IMG.chickenHandi, desc: "Handi-cooked rich chicken." },
  { name: "Chicken Special Roast", price: "500/700", category: "Chicken Items", veg: false, image: IMG.chickenRoast, desc: "Chef's special chicken roast." },
  ...
  { name: "Chicken Garlic", price: "260", category: "Chinese Items", veg: false, image: IMG.chickenGarlic, desc: "Garlicky stir-fried chicken." },
  { name: "Chicken Ginger", price: "260", category: "Chinese Items", veg: false, image: IMG.chickenGinger, desc: "Gingery wok-tossed chicken." },
  ...
  { name: "Chicken Chinga (8 pcs)", price: "200", category: "Chinese Items", veg: false, image: IMG.chickenChinga, desc: "Crunchy chicken chinga bites." },
  { name: "Chicken Roast Roll", price: "180", category: "Chinese Items", veg: false, image: IMG.chickenRoastRoll, desc: "Roasted chicken stuffed in soft roll." },
  ...
  { name: "Egg Do Pyaza (2 pcs)", price: "110", category: "Egg Items", veg: false, image: IMG.eggDoPyaza, desc: "Eggs cooked with double onions." },
  { name: "Egg Kadhai (2 pcs)", price: "150", category: "Egg Items", veg: false, image: IMG.eggKadhai, desc: "Kadhai-style egg curry." },
  { name: "Omelette Curry (2 pcs)", price: "120", category: "Egg Items", veg: false, image: IMG.omeletteCurry, desc: "Omelette pieces in masala gravy." },
  { name: "Egg Butter Masala (2 pcs)", price: "150", category: "Egg Items", veg: false, image: IMG.eggButter, desc: "Buttery rich egg masala." },
  { name: "Egg Handi (2 pcs)", price: "160", category: "Egg Items", veg: false, image: IMG.eggHandi, desc: "Handi-style egg curry." },
  ...
  { name: "Egg Pakoda", price: "120", category: "Egg Items", veg: false, image: IMG.eggPakoda, desc: "Crispy battered egg pakoda." },
  ...
  { name: "Veg Maharashtrian", price: "80/150", category: "Veg Items", veg: true, image: IMG.vegMaharashtra, desc: "Maharashtrian-style mixed veg." },
  ...
  // Chinese Veg Items
  { name: "Mix Chowmein (Non-Veg)", price: "240", category: "Chinese Veg Items", veg: false, image: IMG.mixChowmein, desc: "Wok-tossed mixed non-veg noodles." },
  ...
  { name: "Hakka Chowmein (Non-Veg)", price: "230", category: "Chinese Veg Items", veg: false, image: IMG.hakkaChowmeinNonVeg, desc: "Hakka noodles with chicken & egg." },
  { name: "Maharaja Chilli", price: "250", category: "Chinese Veg Items", veg: true, image: IMG.maharajaChilli, desc: "Chef's special maharaja chilli." },
