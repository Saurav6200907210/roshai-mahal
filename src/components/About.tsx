        ...
        <div>
          <Reveal>
            ...
            <h2 className="mt-3 font-display text-4xl leading-tight sm:text-5xl">
              A taste of <span className="text-gradient-gold">royalty</span>, served in Teghra.
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-5 text-muted-foreground">
              At <strong className="text-foreground">Rosahai Mahal Teghra</strong>, we craft
              cinematic dining experiences inspired by Bihar's rich culinary heritage and the warmth
              of family. Every dish — from our slow-dum biryanis to wood-fired tandoori — is plated
              with care for guests who appreciate the finer things.
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-4 text-muted-foreground">
              With an elegant AC family hall, private celebration room and an open-kitchen vibe, we
              are your favourite address near St. Paul Public School for birthdays, anniversaries
